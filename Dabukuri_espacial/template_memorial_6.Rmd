...
__Lateral esquerda (`r toupper(V$orient_lat_esq)`)__:  `r ifelse(!is.na(V$vizinho_esq), V$vizinho_esq %>% paste0(" confronta-se com o terreno da casa ", . , "."), "")` A linha que une os marcos M-04 (`r M4`) e M-01 (`r M1`) com `r V$dist_lateral` metros. `r ifelse ( ! is.na(tab[i,"obs_lat_esq"]), tab[i,"obs_lat_esq"], "")` 
