...
if ("comunidade" %in% names(tab)) { figure_path <- paste0('figures/',V$comunidade[1], '/casa___', V$id, '.png')
...
if ("comunidade" %in% names(tab)) { figure_path <- paste0('figures/', V$comunidade[1],'/inset/inset__', V$id, '.png')
