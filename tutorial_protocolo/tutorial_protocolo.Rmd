...
Mesmo que haja variação no tipo de terreno e processo de legalização, em
todos os casos lotes individuais devem ser mapeados e ter suas
características espaciais documentadas. Aqui faremos a representação
...
Para melhor visualizar os pontos pode-se habilitar rótulos e cores por
classes (em propriedades da tabela -\> Rótulos e Simbologia - Figura 9).

|                         |                                           |
|-------------------------|-------------------------------------------|
| ![](rotulos_pontos.png) | `Figura 9. Configurar rótulos dos pontos` |
|                         |                                           |
