...
2) o app baseado em [R](www.cran.org) e [Shiny](https://shiny.posit.co) que desenvolvi para usar _templates_ [RMarkdow](https://rmarkdown.rstudio.com) para gerar os documentos em formato _HTML_ (que podem ser impressos em _PDF_ no seu browser).

De acordo com o tipo de terreno e processo de legalização, pode haver variações na documentação exigida. No entanto, lotes individuais devem ser mapeados e ter seus dados documentais disponíveis. Aqui faremos a representação espacial destes terrenos em formato vetorial, extrairemos os dados destas representações e, com esses dados, produziremos o __Memorial Descritivo__ e o __Levantamento Topográfico__ (Figura 1).
...
É sempre bom lembrar que todas as informações necessárias para que os _templates_ dos documentos possam ser preenchidos são obtidos da tabela, que é a fonte de dados dos proprietários, de endereço, dos pontos demarcadores dos terrenos, do comprimento dos lados, área, inclusive o identificador referencial para nomear e chamar as figuras (Figura 5). No modo edição a tabela pode ser editada - lembre-se sempre de salvar as alterações e sair do modo de edição para evitar acidentes.
