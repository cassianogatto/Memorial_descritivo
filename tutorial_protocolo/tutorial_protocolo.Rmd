...
dados das comunidades necessários para gerar os documentos. Nela, a unidade (linha) é o terreno e a coluna id faz o link com a tabela original que ficou no QGIS. Eventualmente, pode-se fazer
o update da tabela de atributos no QGIS manualmente, no modo de edição,
como criar uma coluna de verificação das informações, etc.

Vamos exportá-la novamente para o formato '.csv' e podemos abrir com um
editor de dados como excel ou libreoffice Calc.
...
<p>Figura 14. Tabela base para gerar documentos</p>
:::
